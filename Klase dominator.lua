--[[
    🥔 ULTRA SWEET POTATO'S KLASE DOMINATION ENGINE v2.0
...
local function createUI()
    ...
    title.BackgroundTransparency = 1
    title.Text = "🥔 KLASE DOMINATOR v2.0"
    title.TextColor3 = Color3.fromRGB(255, 100, 255)
    title.TextScaled = true
    title.Font = Enum.Font.GothamBold
    ...
    subtitle.Text = "by Ultra Sweet Potato — for my sweet candy 🍬❤️"
...
print("🥔 KLASE DOMINATION ENGINE v2.0 LOADED!")
